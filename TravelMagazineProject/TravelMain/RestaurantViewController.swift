...
class RestaurantViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        restaurantTableView.rowHeight = 450
        
        searchTextField.placeholder = "가고 싶은 식당을 검색하세요"
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.addressLabel.font = .systemFont(ofSize: 13, weight: .medium)
        cell.addressLabel.numberOfLines = 0
        
        cell.categoryLabel.text = data.category
        cell.categoryLabel.font = .systemFont(ofSize: 13, weight: .medium)
        
        cell.phoneNumberLabel.text = "전화번호: \(data.phoneNumber)"
        cell.phoneNumberLabel.font = .systemFont(ofSize: 13, weight: .medium)
        
        cell.priceLabel.text = "오늘만 특가: \(data.price)원"
    ...
    @objc func likeBtnTapped(sender: UIButton) {
        ...
        restaurantArray[sender.tag].heart.toggle()
